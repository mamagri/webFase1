O site do MiniMercado Magri tem o objetivo de montar uma estrutura de navegação, via browser, para consulta de três categorias de produtos e uma de serviço em seu menu inicial:
